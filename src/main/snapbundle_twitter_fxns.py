...
def add_new_twitter_tweet(parent_object_urn, tweet):
    ...
    snapbundle_helpers.add_update_metadata("ObjectInteraction", moniker, "String", "contributors", snapbundle_helpers.get_raw_value_encoded(tweet.contributors, "String"))
    return
